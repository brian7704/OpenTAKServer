...
def upgrade():
    ...
    with op.batch_alter_table("data_packages", schema=None) as batch_op:
        batch_op.create_foreign_key(
            "data_packages_eud", "euds", ["creator_uid"], ["uid"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("geochat", schema=None) as batch_op:
        batch_op.create_foreign_key(
            "geochat_eud", "euds", ["sender_uid"], ["uid"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("mission_invitations", schema=None) as batch_op:
        batch_op.create_foreign_key(
            "mission_invitation_eud", "euds", ["client_uid"], ["uid"], ondelete="CASCADE"
        )
        batch_op.create_foreign_key(
            "mission_invitation_callsign", "euds", ["callsign"], ["callsign"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("missions", schema=None) as batch_op:
        batch_op.create_foreign_key(
            "mission_creator", "euds", ["creator_uid"], ["uid"], ondelete="CASCADE"
        )
...
def downgrade():
    ...
    with op.batch_alter_table("mission_invitations", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "mission_invitation_callsign", "euds", ["callsign"], ["callsign"]
        )
