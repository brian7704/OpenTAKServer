...
Revision ID: 4c8766b0a993
Revises: 00442761c803
Create Date: 2026-06-05 14:22:15.839899
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "archive", sa.Boolean(), nullable=False, false_values=(False, "False", "false", "")
        ),
        sa.Column(
            "federate_group_matching",
            sa.Boolean(),
            nullable=False,
            false_values=(False, "False", "false", ""),
        ),
        sa.Column(
            "automatic_group_matching",
            sa.Boolean(),
            nullable=False,
            false_values=(False, "False", "false", ""),
        ),
        sa.Column(
            "fallback_group_matching",
            sa.Boolean(),
            nullable=False,
            false_values=(False, "False", "false", ""),
        ),
