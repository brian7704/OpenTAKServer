...
def upgrade():
    ...
    with op.batch_alter_table("alerts", schema=None) as batch_op:
        batch_op.create_foreign_key(
            "alert_point", "points", ["point_id"], ["id"], ondelete="CASCADE"
        )
        batch_op.create_foreign_key(
            "alert_eud", "euds", ["sender_uid"], ["uid"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("casevac", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "casevac_eud", "euds", ["sender_uid"], ["uid"], ondelete="CASCADE"
        )
        batch_op.create_foreign_key(
            "casevac_point", "points", ["point_id"], ["id"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("certificates", schema=None) as batch_op:
        batch_op.create_foreign_key(
            "certificate_eud", "euds", ["eud_uid"], ["uid"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("markers", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "markers_eud", "euds", ["parent_uid"], ["uid"], ondelete="CASCADE"
        )
        batch_op.create_foreign_key(
            "markers_point", "points", ["point_id"], ["id"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("points", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "point_eud", "euds", ["device_uid"], ["uid"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("rb_lines", schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(
            "rb_line_eud", "euds", ["sender_uid"], ["uid"], ondelete="CASCADE"
        )
        batch_op.create_foreign_key(
            "rb_line_point", "points", ["point_id"], ["id"], ondelete="CASCADE"
        )
    ...
    with op.batch_alter_table("zmist", schema=None) as batch_op:
        batch_op.create_foreign_key(
            "zmist_casevac", "casevac", ["casevac_uid"], ["uid"], ondelete="CASCADE"
        )
