...
def upgrade():
    ...
    sa.Column('cot_type', sa.String(), nullable=True),
...
def downgrade():
    ...
    sa.Column('creator_uid', sa.VARCHAR(), nullable=False),
    sa.Column('entry_uid', sa.VARCHAR(), nullable=False),
    ...
    sa.Column('mission_name', sa.VARCHAR(), nullable=True),
