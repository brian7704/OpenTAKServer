...
def upgrade():
    ...
    try:
        ...
        sa.Column('group_owner', sa.String(), nullable=True),
        sa.Column('parent', sa.String(), nullable=True),
        sa.PrimaryKeyConstraint('id')
        )
    except sa.exc.OperationalError:
        logger.warning('Chatrooms table already exists, skipping')

    try:
        op.create_table('icons',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('iconset_uid', sa.String(), nullable=True),
        sa.Column('filename', sa.String(), nullable=True),
        sa.Column('groupName', sa.String(), nullable=True),
        sa.Column('type2525b', sa.String(), nullable=True),
        ...
        logger.warning('Icons table already exists, skipping')
    ...
    try:
        ...
        logger.warning('Role table already exists, skipping')
    ...
    try:
        ...
        logger.warning('User table already exists, skipping')
    ...
    try:
        ...
        logger.warning('roles_users table already exists, skipping')
    ...
    try:
        ...
        logger.warning('Teams table already exists, skipping')
    ...
    try:
        ...
        logger.warning('Webauthn table already exists, skipping')
    ...
    try:
        ...
        logger.warning('EUDs table already exists, skipping')
    ...
    try:
        ...
        logger.warning('Chatrooms_Uids table already exists, skipping')
    ...
    try:
        ...
        sa.Column('sender_callsign', sa.String(), nullable=False),
        sa.Column('sender_device_name', sa.String(), nullable=True),
        sa.Column('sender_uid', sa.String(), nullable=True),
        ...
        logger.warning('CoT table already exists, skipping')
    ...
    try:
        ...
        logger.warning('Data packages table already exists, skipping')

    try:
        op.create_table('certificates',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('common_name', sa.String(), nullable=False),
        sa.Column('eud_uid', sa.String(), nullable=True),
        ...
        sa.Column('truststore_filename', sa.String(), nullable=False),
        sa.Column('user_cert_filename', sa.String(), nullable=False),
        sa.Column('csr', sa.String(), nullable=True),
        sa.Column('cert_password', sa.String(), nullable=False),
        ...
        logger.warning('Certificates table already exists, skipping')
    ...
    try:
        ...
        logger.warning('Points table already exists, skipping')
    ...
    try:
        ...
        sa.Column('preferred_mac_address', sa.String(), nullable=True),
        sa.Column('preferred_interface_address', sa.String(), nullable=True),
        sa.Column('username', sa.String(), nullable=True),
        sa.Column('xml', sa.String(), nullable=True),
        sa.Column('ready', sa.Boolean(), nullable=False),
        sa.Column('mediamtx_settings', sa.String(), nullable=False),
        sa.Column('cot_id', sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(['cot_id'], ['cot.id'], ),
        sa.ForeignKeyConstraint(['username'], ['user.username'], ),
        ...
        logger.warning('Video streams table already exists, skipping')
    ...
    try:
        ...
        logger.warning('Alerts table already exists, skipping')
    ...
    try:
        ...
        sa.Column('enemy', sa.String(), nullable=True),
        sa.Column('epw', sa.Integer(), nullable=True),
        sa.Column('equipment_detail', sa.String(), nullable=True),
        ...
        sa.Column('friendlies', sa.String(), nullable=True),
        sa.Column('hlz_marking', sa.Integer(), nullable=True),
        sa.Column('hlz_remarks', sa.String(), nullable=True),
        ...
        sa.Column('medline_remarks', sa.String(), nullable=True),
        ...
        sa.Column('terrain_other_detail', sa.String(), nullable=True),
        sa.Column('terrain_detail', sa.String(), nullable=True),
        ...
        sa.Column('terrain_slope_dir', sa.String(), nullable=True),
        ...
        sa.Column('winds_are_from', sa.String(), nullable=True),
        ...
        logger.warning('CasEvac table already exists, skipping')
    ...
    try:
        ...
        logger.warning('geochat table already exists, skipping')
    ...
    try:
        ...
        sa.Column('battle_dimension', sa.String(), nullable=True),
        sa.Column('point_id', sa.Integer(), nullable=False),
        sa.Column('callsign', sa.String(), nullable=True),
        ...
        sa.Column('iconset_path', sa.String(), nullable=True),
        sa.Column('parent_callsign', sa.String(), nullable=True),
        sa.Column('production_time', sa.String(), nullable=True),
        ...
        sa.Column('cot_id', sa.Integer(), nullable=True),
        sa.Column('mil_std_2525c', sa.String(), nullable=True),
        sa.ForeignKeyConstraint(['cot_id'], ['cot.id'], ),
        ...
        logger.warning('Markers table already exists, skipping')
    ...
    try:
        ...
        sa.Column('anchor_uid', sa.String(), nullable=True),
        ...
        sa.Column('stroke_style', sa.String(), nullable=True),
        ...
        logger.warning('rb_lines table already exists, skipping')

    try:
        op.create_table('video_recordings',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('segment_path', sa.String(), nullable=False),
        sa.Column('path', sa.String(), nullable=False),
        ...
        logger.warning('Video recordings table already exists, skipping')

    try:
        op.create_table('zmist',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('i', sa.String(), nullable=True),
        ...
        sa.Column('casevac_uid', sa.String(), nullable=False),
