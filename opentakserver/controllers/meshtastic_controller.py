        ...
        try:
            if event:
                ...
                if portnum == "TEXT_MESSAGE_APP":
                    ...
                    self.rabbit_channel.basic_publish(exchange='groups', routing_key='__ANON__.OUT', body=message,properties=pika.BasicProperties(expiration=self.context.app.config.get("OTS_RABBITMQ_TTL")))
