...
class EUD(db.Model):
    ...
    certificate = relationship("Certificate", cascade="all, delete-orphan", back_populates="eud", uselist=False)
    markers = relationship("Marker", cascade="all, delete-orphan", back_populates="eud")
