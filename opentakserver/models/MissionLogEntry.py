...
class MissionLogEntry(db.Model):
    ...
    dtg: Mapped[datetime] = mapped_column(
        DateTime, default=datetime.datetime.now(datetime.timezone.utc)
    )
    ...
    def generate_cot(self) -> Element:
        ...
        SubElement(
            event,
            "point",
            {"ce": "9999999", "le": "9999999", "hae": "0.0", "lat": "0.0", "lon": "0.0"},
        )
        ...
        SubElement(
            ...
            "mission",
            {
                "type": MissionChange.CHANGE,
                "tool": "public",
                "name": self.mission.name,
                "guid": self.mission.guid,
                "authorUid": self.creator_uid,
            },
        )
